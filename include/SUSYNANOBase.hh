...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ULong64_t       event;
   UInt_t          nPFcand;
   Float_t         PFcand_chiso0p1[80];   //[nPFcand]
   Float_t         PFcand_chiso0p2[80];   //[nPFcand]
   Float_t         PFcand_chiso0p3[80];   //[nPFcand]
   Float_t         PFcand_chiso0p4[80];   //[nPFcand]
   Float_t         PFcand_totiso0p1[80];   //[nPFcand]
   Float_t         PFcand_totiso0p2[80];   //[nPFcand]
   Float_t         PFcand_totiso0p3[80];   //[nPFcand]
   Float_t         PFcand_totiso0p4[80];   //[nPFcand]
   Float_t         PFcand_trackiso[80];   //[nPFcand]
   Float_t         PFcand_nearphopt[80];   //[nPFcand]
   Float_t         PFcand_nearphoeta[80];   //[nPFcand]
   Float_t         PFcand_nearphophi[80];   //[nPFcand]
   Float_t         PFcand_nearestTrkDR[80];   //[nPFcand]
   Int_t           PFcand_contJetIndex[80];   //[nPFcand]
   ...
   Float_t         Electron_mvaSpring16GP[15];   //[nElectron]
   Float_t         Electron_mvaSpring16HZZ[15];   //[nElectron]
   ...
   Int_t           Electron_cutBased_HLTPreSel[15];   //[nElectron]
   Int_t           Electron_cutBased_Spring15[15];   //[nElectron]
   Int_t           Electron_cutBased_Sum16[15];   //[nElectron]
   ...
   Int_t           Electron_vidNestedWPBitmapSpring15[15];   //[nElectron]
   Int_t           Electron_vidNestedWPBitmapSum16[15];   //[nElectron]
   ...
   Bool_t          Electron_mvaSpring16GP_WP80[15];   //[nElectron]
   Bool_t          Electron_mvaSpring16GP_WP90[15];   //[nElectron]
   Bool_t          Electron_mvaSpring16HZZ_WPL[15];   //[nElectron]
   UInt_t          nFatJet;
   ...
   Float_t         FatJet_deepTagMD_H4qvsQCD[10];   //[nFatJet]
   Float_t         FatJet_deepTagMD_HbbvsQCD[10];   //[nFatJet]
   Float_t         FatJet_deepTagMD_TvsQCD[10];   //[nFatJet]
   Float_t         FatJet_deepTagMD_WvsQCD[10];   //[nFatJet]
   Float_t         FatJet_deepTagMD_ZHbbvsQCD[10];   //[nFatJet]
   Float_t         FatJet_deepTagMD_ZHccvsQCD[10];   //[nFatJet]
   Float_t         FatJet_deepTagMD_ZbbvsQCD[10];   //[nFatJet]
   Float_t         FatJet_deepTagMD_ZvsQCD[10];   //[nFatJet]
   Float_t         FatJet_deepTagMD_bbvsLight[10];   //[nFatJet]
   Float_t         FatJet_deepTagMD_ccvsLight[10];   //[nFatJet]
   Float_t         FatJet_deepTag_TvsQCD[10];   //[nFatJet]
   Float_t         FatJet_deepTag_WvsQCD[10];   //[nFatJet]
   Float_t         FatJet_deepTag_ZvsQCD[10];   //[nFatJet]
   ...
   UInt_t          nGenJet;
   Float_t         GenJet_eta[30];   //[nGenJet]
   Float_t         GenJet_mass[30];   //[nGenJet]
   Float_t         GenJet_phi[30];   //[nGenJet]
   Float_t         GenJet_pt[30];   //[nGenJet]
   UInt_t          nGenPart;
   ...
   Int_t           GenVisTau_charge[10];   //[nGenVisTau]
   Int_t           GenVisTau_genPartIdxMother[10];   //[nGenVisTau]
   Int_t           GenVisTau_status[10];   //[nGenVisTau]
   Float_t         genWeight;
   ...
   UInt_t          nJet;
   Float_t         Jet_CvsB[40];   //[nJet]
   Float_t         Jet_CvsL[40];   //[nJet]
   ...
   Float_t         Jet_chHadMult[40];   //[nJet]
   Float_t         Jet_deepCSVb[40];   //[nJet]
   Float_t         Jet_deepCSVbb[40];   //[nJet]
   Float_t         Jet_deepCSVc[40];   //[nJet]
   Float_t         Jet_deepCSVudsg[40];   //[nJet]
   Float_t         Jet_deepFlavourb[40];   //[nJet]
   Float_t         Jet_deepFlavourbb[40];   //[nJet]
   Float_t         Jet_deepFlavourc[40];   //[nJet]
   Float_t         Jet_deepFlavourg[40];   //[nJet]
   Float_t         Jet_deepFlavourlepb[40];   //[nJet]
   Float_t         Jet_deepFlavouruds[40];   //[nJet]
   Float_t         Jet_elEF[40];   //[nJet]
   Float_t         Jet_elMult[40];   //[nJet]
   Float_t         Jet_eta[40];   //[nJet]
   Float_t         Jet_hfEMEF[40];   //[nJet]
   Float_t         Jet_hfHadEF[40];   //[nJet]
   Float_t         Jet_mass[40];   //[nJet]
   Float_t         Jet_muEF[40];   //[nJet]
   Float_t         Jet_muMult[40];   //[nJet]
   Float_t         Jet_neEmEF[40];   //[nJet]
   Float_t         Jet_neHEF[40];   //[nJet]
   Float_t         Jet_neHadMult[40];   //[nJet]
   Float_t         Jet_phEF[40];   //[nJet]
   Float_t         Jet_phMult[40];   //[nJet]
   Float_t         Jet_phi[40];   //[nJet]
   Float_t         Jet_pt[40];   //[nJet]
   Float_t         Jet_qgAxis1[40];   //[nJet]
   Float_t         Jet_qgAxis2[40];   //[nJet]
   Float_t         Jet_qgl[40];   //[nJet]
   Float_t         Jet_qgptD[40];   //[nJet]
   ...
   UChar_t         LHE_NpLO;
   UInt_t          nLHEPart;
   Float_t         LHEPart_pt[15];   //[nLHEPart]
   Float_t         LHEPart_eta[15];   //[nLHEPart]
   Float_t         LHEPart_phi[15];   //[nLHEPart]
   Float_t         LHEPart_mass[15];   //[nLHEPart]
   Int_t           LHEPart_pdgId[15];   //[nLHEPart]
   Float_t         GenMET_phi;
   Float_t         GenMET_pt;
   ...
   UInt_t          nPhoton;
   Float_t         Photon_eCorr[20];   //[nPhoton]
   Float_t         Photon_energyErr[20];   //[nPhoton]
   Float_t         Photon_eta[20];   //[nPhoton]
   Float_t         Photon_hoe[20];   //[nPhoton]
   Float_t         Photon_mass[20];   //[nPhoton]
   Float_t         Photon_mvaID[20];   //[nPhoton]
   Float_t         Photon_mvaID17[20];   //[nPhoton]
   Float_t         Photon_pfRelIso03_all[20];   //[nPhoton]
   Float_t         Photon_pfRelIso03_chg[20];   //[nPhoton]
   Float_t         Photon_phi[20];   //[nPhoton]
   Float_t         Photon_pt[20];   //[nPhoton]
   Float_t         Photon_r9[20];   //[nPhoton]
   Float_t         Photon_sieie[20];   //[nPhoton]
   Int_t           Photon_charge[20];   //[nPhoton]
   Int_t           Photon_cutBased[20];   //[nPhoton]
   Int_t           Photon_cutBased17Bitmap[20];   //[nPhoton]
   Int_t           Photon_electronIdx[20];   //[nPhoton]
   Int_t           Photon_jetIdx[20];   //[nPhoton]
   Int_t           Photon_pdgId[20];   //[nPhoton]
   ...
   Bool_t          Photon_mvaID17_WP80[20];   //[nPhoton]
   Bool_t          Photon_mvaID17_WP90[20];   //[nPhoton]
   ...
   Float_t         ResolvedTopCandidate_discriminator[50];   //[nResolvedTopCandidate]
   Float_t         ResolvedTopCandidate_eta[50];   //[nResolvedTopCandidate]
   Float_t         ResolvedTopCandidate_mass[50];   //[nResolvedTopCandidate]
   Float_t         ResolvedTopCandidate_phi[50];   //[nResolvedTopCandidate]
   Float_t         ResolvedTopCandidate_pt[50];   //[nResolvedTopCandidate]
   Int_t           ResolvedTopCandidate_j1Idx[50];   //[nResolvedTopCandidate]
   Int_t           ResolvedTopCandidate_j2Idx[50];   //[nResolvedTopCandidate]
   Int_t           ResolvedTopCandidate_j3Idx[50];   //[nResolvedTopCandidate]
   Int_t           ResolvedTopCandidate_type[50];   //[nResolvedTopCandidate]
   Float_t         fixedGridRhoFastjetAll;
   Float_t         fixedGridRhoFastjetCentralCalo;
   Float_t         fixedGridRhoFastjetCentralNeutral;
   UInt_t          nGenDressedLepton;
   Float_t         GenDressedLepton_eta[12];   //[nGenDressedLepton]
   Float_t         GenDressedLepton_mass[12];   //[nGenDressedLepton]
   Float_t         GenDressedLepton_phi[12];   //[nGenDressedLepton]
   Float_t         GenDressedLepton_pt[12];   //[nGenDressedLepton]
   Int_t           GenDressedLepton_pdgId[12];   //[nGenDressedLepton]
   ...
   UInt_t          nSB;
   Float_t         SB_dlen[10];   //[nSB]
   Float_t         SB_dlenSig[10];   //[nSB]
   Float_t         SB_DdotP[10];   //[nSB]
   Float_t         SB_dxy[10];   //[nSB]
   Float_t         SB_dxySig[10];   //[nSB]
   Int_t           SB_JetIdx[10];   //[nSB]
   UInt_t          nSubJet;
   Float_t         SubJet_btagCMVA[20];   //[nSubJet]
   Float_t         SubJet_btagCSVV2[20];   //[nSubJet]
   Float_t         SubJet_btagDeepB[20];   //[nSubJet]
   Float_t         SubJet_eta[20];   //[nSubJet]
   Float_t         SubJet_mass[20];   //[nSubJet]
   Float_t         SubJet_n2b1[20];   //[nSubJet]
   Float_t         SubJet_n3b1[20];   //[nSubJet]
   Float_t         SubJet_phi[20];   //[nSubJet]
   Float_t         SubJet_pt[20];   //[nSubJet]
   Float_t         SubJet_rawFactor[20];   //[nSubJet]
   Float_t         SubJet_tau1[20];   //[nSubJet]
   Float_t         SubJet_tau2[20];   //[nSubJet]
   Float_t         SubJet_tau3[20];   //[nSubJet]
   Float_t         SubJet_tau4[20];   //[nSubJet]
   UInt_t          nTau;
   ...
   Float_t         PFcand_dz[80];   //[nPFcand]
   Float_t         PFcand_eta[80];   //[nPFcand]
   Float_t         PFcand_fromPV[80];   //[nPFcand]
   Float_t         PFcand_mass[80];   //[nPFcand]
   Float_t         PFcand_phi[80];   //[nPFcand]
   Float_t         PFcand_pt[80];   //[nPFcand]
   Int_t           Electron_genPartIdx[15];   //[nElectron]
   UChar_t         Electron_genPartFlav[15];   //[nElectron]
   Int_t           GenJetAK8_partonFlavour[12];   //[nGenJetAK8]
   UChar_t         GenJetAK8_hadronFlavour[12];   //[nGenJetAK8]
   ...
   Int_t           Photon_genPartIdx[20];   //[nPhoton]
   ...
   UChar_t         Photon_cleanmask[20];   //[nPhoton]
   UChar_t         Tau_cleanmask[15];   //[nTau]
   Float_t         SB_chi2[10];   //[nSB]
   Float_t         SB_eta[10];   //[nSB]
   Float_t         SB_mass[10];   //[nSB]
   Float_t         SB_ndof[10];   //[nSB]
   Float_t         SB_phi[10];   //[nSB]
   Float_t         SB_pt[10];   //[nSB]
   Int_t           SB_ntracks[10];   //[nSB]
