...
// Fri Sep 30 11:57:40 2022 by ROOT version 6.14/09
// from TTree llpgtree/llpgtree
// found on file: llpgana_mc_AODSIM_ntuplizer_test.root
//////////////////////////////////////////////////////////

//#ifndef llpgana_hist_base_h
//#define llpgana_hist_base_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //llpgana_hist_base(TTree *tree=0);
   //virtual ~llpgana_hist_base();
...
//#ifdef llpgana_hist_base_cxx
/*
llpgana_hist_base::llpgana_hist_base(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("llpgana_mc_AODSIM_ntuplizer_test.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("llpgana_mc_AODSIM_ntuplizer_test.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("llpgana_mc_AODSIM_ntuplizer_test.root:/tree");
...
llpgana_hist_base::~llpgana_hist_base()
{
   if (!fChain) return;
...
Int_t llpgana_hist_base::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t llpgana_hist_base::LoadTree(Long64_t entry)
{
...
*/
void llpgana_hist_base::Init(TTree *tree)
{
...
/*
Bool_t llpgana_hist_base::Notify()
{
...
void llpgana_hist_base::Show(Long64_t entry)
{
...
Int_t llpgana_hist_base::Cut(Long64_t entry)
{
...
*/
//#endif // #ifdef llpgana_hist_base_cxx
