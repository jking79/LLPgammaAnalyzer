...
// Wed Jan 24 15:22:38 2024 by ROOT version 6.14/09
// from TTree llpgtree/KUCMSNtuple
// found on file: output_12.root
//////////////////////////////////////////////////////////
...
#ifdef v14sample_cxx
v14sample::v14sample(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("output_12.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("output_12.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("output_12.root:/tree");
...
Int_t v14sample::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t v14sample::LoadTree(Long64_t entry)
{
...
void v14sample::Init(TTree *tree)
{
...
void v14sample::Show(Long64_t entry)
{
...
Int_t v14sample::Cut(Long64_t entry)
{
