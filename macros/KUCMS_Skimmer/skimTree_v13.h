...
// Mon Dec 11 13:24:33 2023 by ROOT version 6.14/09
// from TTree kuSkimTree/output root file for kUCMSSkimmer
// found on file: skims_files/kuntuple_GMSB_L-350TeV_Ctau-1000cm_v13_Ntuple_v11_LLPgama_Skim_v13.root
//////////////////////////////////////////////////////////

#ifndef skimTree_v13_h
#define skimTree_v13_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   skimTree_v13(TTree *tree=0);
   virtual ~skimTree_v13();
...
#ifdef skimTree_v13_cxx
skimTree_v13::skimTree_v13(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("skims_files/kuntuple_GMSB_L-350TeV_Ctau-1000cm_v13_Ntuple_v11_LLPgama_Skim_v13.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("skims_files/kuntuple_GMSB_L-350TeV_Ctau-1000cm_v13_Ntuple_v11_LLPgama_Skim_v13.root");
      }
...
skimTree_v13::~skimTree_v13()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t skimTree_v13::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t skimTree_v13::LoadTree(Long64_t entry)
{
...
void skimTree_v13::Init(TTree *tree)
{
...
void skimTree_v13::Show(Long64_t entry)
{
...
Int_t skimTree_v13::Cut(Long64_t entry)
{
