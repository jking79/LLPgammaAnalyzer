...
command = eosll+mdis+'KUCMSNtuple/kucmsntuple_QCD_R17_v16_MET0/'
#command = eosll+mdis+'KUCMSNtuple/kucmsntuple_GMSB_AOD_v144/'
#command = eosll+mdis+'KUCMSNtuple/kucmsntuple_GMSB_R17_v15/'
#command = eosll+mdis+'KUCMSNtuple/kucmsntuple_GMSB_R17_v16/'
...
for line2 in targdirs :
    ...
    outfile = 'kuntuple_' + select[0] + 'R17_v16_Met0.txt'
    #print( outfile )
    outf = open( outfile, 'w' )
