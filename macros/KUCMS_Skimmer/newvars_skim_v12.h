...
// Thu Nov 16 13:32:08 2023 by ROOT version 6.14/09
// from TTree kuSkimTree/output root file for kUCMSSkimmer
// found on file: kuntuple_GMSB_L-100TeV_Ctau-10000cm_v10_Ntuple_v10_LLPgama_Skim_v12.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   aector<float>   *selJetNeH        *b_DataSetKey;   //!
   TBranch        *b_evtGenWgt;   //!;
...
#ifdef newvars_cxx
newvars::newvars(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("kuntuple_GMSB_L-100TeV_Ctau-10000cm_v10_Ntuple_v10_LLPgama_Skim_v12.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("kuntuple_GMSB_L-100TeV_Ctau-10000cm_v10_Ntuple_v10_LLPgama_Skim_v12.root");
      }
