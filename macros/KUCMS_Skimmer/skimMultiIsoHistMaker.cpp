...
//        if( isOthersusy && not isPrompt ){ usepho = false; continue; }
        ...
        hist2d[213]->Fill((*selPhoHcalTowerSumEtBcConeDR04)[it],(*selPhoTrkSumPtHollowConeDR04)[it]);
        ...
        hist1d[128]->Fill((*selPhoTrkSumPtHollowConeDR04)[it],fillwt); //("phoPt", "phoPt", 500, 0, 5000);
        hist2d[209]->Fill((*selPhoTrkSumPtHollowConeDR04)[it],(*selPhoPt)[it]);
        hist2d[216]->Fill((*selPhoTrkSumPtHollowConeDR04)[it],(*selPhoEcalRHSumEtConeDR04)[it]);
        hist2d[217]->Fill((*selPhoTrkSumPtHollowConeDR04)[it],(*selPhoHadTowOverEM)[it]);
        ...
        if( (*selPhoPt)[it] >= 30  ){
            ...
            hist1d[158]->Fill((*selPhoTrkSumPtHollowConeDR04)[it],fillwt); //("phoGeoSMaj", "phoGeoSMaj", 100, 0, 1);
        ...
        if( (*selPhoPt)[it] >= 100 ){
            ...
            hist1d[208]->Fill((*selPhoTrkSumPtHollowConeDR04)[it],fillwt); //("phoGeoSMaj", "phoGeoSMaj", 100, 0, 1);
