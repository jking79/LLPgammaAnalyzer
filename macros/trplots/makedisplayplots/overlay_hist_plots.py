...
dostack(hl_other_plots, outname, date, Ic_layout, ptitle,  y, x, l, t)
#dostack(hl_mc_wap, outname, date, Ic_layout, ptitle,  y, x, l, t)

#ptitle=[' DYJetsToLL','','#splitline{ECAL Barrel}{pCalo energy}']
#y = [ 100000, 1 ]
#x = [ 2, 12 ]
...
#t = [0.225,0.825,0.0]
#t = [0.225,0.875,0.0]
#outname = 'downloads/tr_pcaloE_hist'
#dostack(hl_other_plots, outname, date, Ic_layout, ptitle,  y, x, l, t)

ptitle=[' DYJetsToLL','','#splitline{ECAL Barrel}{pCalo TOF}']
y = [ 20000, 0 ]
x = [ 0.0, 12.0 ] 
l = [ 0.7,0.65,0.925,0.9 ]
#l = [ 0.7,0.66,0.9,0.9]
#t = [0.35,0.825,0.09,0.175,0.225]
t = [0.225,0.825,0.0]
outname = 'downloads/tr_mc_pcalo_pctof_dist'
#dostack(hl_mc_plots, outname, date, Ic_layout, ptitle,  y, x, l, t)
...
#y = [ 1000000, 1 ]
#x = [ -800.0, 80.0 ]
#l = [ 0.6,0.60,0.85,0.85 ]
#t = [0.225,0.77,0.0]
#outname = 'downloads/tr_kurh_dootamp_plot'
#dostack(hl_dootamps, outname, date, Ic_layout, ptitle, y, x, l, t)
...
#l = [ 0.6,0.60,0.85,0.85 ]
#t = [0.325,0.77,0.0]
#outname = 'downloads/tr_kurh_ootamp_plot'
#dostack(hl_ootamps, outname, date, Ic_layout, ptitle, y, x, l, t)

#ptitle=['','Run 2 ','#splitline{ECAL Barrel}{Same RO unit}']
#y = [ 0.6, 0.2 ]
#x = [ 0.0, 100.0 ]
#l = [ 0.775,0.55,0.925,0.9 ]
#t = [0.225,0.825,0.08,0.325,0.70]
#outname = 'downloads/tr_mini_678_etest'
#dostack(hl_ot_678_e, outname, date, Ic_layout, ptitle,  y, x, l, t)
