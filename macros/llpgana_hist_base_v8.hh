...
// Mon Oct 17 12:22:52 2022 by ROOT version 6.14/09
// from TTree llpgtree/llpgtree
// found on file: llpgana_mc_AODSIM_ntuplizer_test_v8.root
//////////////////////////////////////////////////////////

//#ifndef llpgana_hist_v8_h
//#define llpgana_hist_v8_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //llpgana_hist_v8(TTree *tree=0);
   //virtual ~llpgana_hist_v8();
...
//#ifdef llpgana_hist_v8_cxx
/*
llpgana_hist_v8::llpgana_hist_v8(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("llpgana_mc_AODSIM_ntuplizer_test_v8.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("llpgana_mc_AODSIM_ntuplizer_test_v8.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("llpgana_mc_AODSIM_ntuplizer_test_v8.root:/tree");
...
llpgana_hist_v8::~llpgana_hist_v8()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t llpgana_hist_v8::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t llpgana_hist_v8::LoadTree(Long64_t entry)
{
...
void llpgana_hist_v8::Init(TTree *tree)
{
...
void llpgana_hist_v8::Show(Long64_t entry)
{
...
Int_t llpgana_hist_v8::Cut(Long64_t entry)
{
...
*/
//#endif // #ifdef llpgana_hist_v8_cxx
