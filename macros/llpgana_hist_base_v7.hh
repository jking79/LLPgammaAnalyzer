...
// Thu Oct 13 12:50:49 2022 by ROOT version 6.14/09
// from TTree llpgtree/llpgtree
// found on file: llpgana_mc_AODSIM_ntuplizer_test_v7.root
//////////////////////////////////////////////////////////

//#ifndef llpgana_base_v7_h
//#define llpgana_base_v7_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nCaloJets;
   vector<vector<unsigned int> > *cljRhIds;
  ...
  // llpgana_base_v7(TTree *tree=0);
  // virtual ~llpgana_base_v7();
...
//#ifdef llpgana_base_v7_cxx
/*
llpgana_base_v7::llpgana_base_v7(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("llpgana_mc_AODSIM_ntuplizer_test_v7.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("llpgana_mc_AODSIM_ntuplizer_test_v7.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("llpgana_mc_AODSIM_ntuplizer_test_v7.root:/tree");
...
llpgana_base_v7::~llpgana_base_v7()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t llpgana_base_v7::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t llpgana_base_v7::LoadTree(Long64_t entry)
{
...
void llpgana_base_v7::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("cljRhIds", &cljRhIds, &b_cljRhIds);
...
void llpgana_base_v7::Show(Long64_t entry)
{
...
Int_t llpgana_base_v7::Cut(Long64_t entry)
{
...
*/
//#endif // #ifdef llpgana_base_v7_cxx
