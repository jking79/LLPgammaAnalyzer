...
// Thu Dec  1 13:04:04 2022 by ROOT version 6.14/09
// from TTree llpgtree/llpgtree
// found on file: llpgana_mc_AODSIM_ntuplizer_test_v11.root
//////////////////////////////////////////////////////////

//#ifndef llpgana_hist_base_v10_h
//#define llpgana_hist_base_v10_h
...
//   llpgana_hist_base_v10(TTree *tree=0);
//   virtual ~llpgana_hist_base_v10();
...
//#ifdef llpgana_hist_base_v10_cxx
/*
llpgana_hist_base_v10::llpgana_hist_base_v10(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("llpgana_mc_AODSIM_ntuplizer_test_v11.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("llpgana_mc_AODSIM_ntuplizer_test_v11.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("llpgana_mc_AODSIM_ntuplizer_test_v11.root:/tree");
...
llpgana_hist_base_v10::~llpgana_hist_base_v10()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t llpgana_hist_base_v10::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t llpgana_hist_base_v10::LoadTree(Long64_t entry)
{
...
void llpgana_hist_base_v10::Init(TTree *tree)
{
...
/*
Bool_t llpgana_hist_base_v10::Notify()
{
...
void llpgana_hist_base_v10::Show(Long64_t entry)
{
...
Int_t llpgana_hist_base_v10::Cut(Long64_t entry)
{
...
*/
//#endif // #ifdef llpgana_hist_base_v10_cxx
